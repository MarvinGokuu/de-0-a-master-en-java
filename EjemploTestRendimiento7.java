...
public class EjemploTestRendimiento7 {
    public static void main(String[] args) {
        ...
        do {
            // CAMBIO: Se agrega la advertencia del límite máximo de 'int' al mensaje.
            nEntrada = JOptionPane.showInputDialog(
                "Ingrese el tiempo base (segundos).\n" + 
                "El valor no debe exceder: 2,147,483,647."
            );
            ...
            try {
                ...
                // Este catch ya maneja correctamente números inválidos o que exceden el límite de 'int'.
                JOptionPane.showMessageDialog(null,
                        "\"" + nEntrada + "\" no es un número válido. El valor excede el límite de 2,147,483,647.",
                        "Error de Entrada",
