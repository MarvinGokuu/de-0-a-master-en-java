// Octonion3DExample.java
// Ejemplo JavaFX: escena 3D donde objetos se "rotan" aplicando conjugación por OCTONIONES.
// Requiere JavaFX (añadir módulos si tu JDK no lo incluye).
...
public class Octonion3DExample extends Application {
    ...
    private final double sceneCenterX = 0;
    private final double sceneCenterY = 0;
    private final double sceneCenterZ = 0;
