...
public class EjemploTestRendimiento4 {
    public static void main(String[] args) {
        ...
        do {
            nEntrada = JOptionPane.showInputDialog("Ingrese el número de iteraciones:");
            ...
            try {
                ...
                iteraciones = numeroInt; // Asignar el valor a iteraciones
        ...
        // } else {
        // System.out.println("Entrada inválida. Usando valor predeterminado de 100000
        // ms.");
        // scanner.close();
        // }
...
// JOptionPane.showMessageDialog(null, "mensaje");
/*
 * JOptionPane.showMessageDialog(null, "Esto es información", "Info",
 ...
 * //m1 = JOptionPane.showMessageDialog(null, "Esto es información", "Info",
 * JOptionPane.INFORMATION_MESSAGE);
 * //m2 = JOptionPane.showMessageDialog(null, "Esto es una advertencia",
 * "Cuidado", JOptionPane.WARNING_MESSAGE);
 * //m3 = JOptionPane.showMessageDialog(null, "Esto es un error", "Error",
 * JOptionPane.ERROR_MESSAGE);
 * //m4 = JOptionPane.showMessageDialog(null, "Esto es una pregunta",
 * "Pregunta", JOptionPane.QUESTION_MESSAGE);
 * //m5 = JOptionPane.showMessageDialog(null, "Esto es un mensaje simple",
 * "Simple", JOptionPane.PLAIN_MESSAGE);
 * //m6 = JOptionPane.showMessageDialog(null, "Esto es un mensaje plano",
 * "Plano", JOptionPane.PLAIN_MESSAGE);
 * //m7 = JOptionPane.showMessageDialog(null,
 * "Esto es un mensaje personalizado", "
 * //" + "Custom", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("ruta/a/imagen
 * .png"));
 */
