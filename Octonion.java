...
public class Octonion {
    ...
    public Octonion(double[] components) {
        if (components.length != 8) {
            throw new IllegalArgumentException("Octonion must have 8 components.");
        }
        this.a0 = components[0];
        this.a1 = components[1];
        this.a2 = components[2];
        this.a3 = components[3];
        this.a4 = components[4];
        this.a5 = components[5];
        this.a6 = components[6];
        this.a7 = components[7];
    }

    public Octonion(double real) {
        this(real, 0, 0, 0, 0, 0, 0, 0);
    }

    // Static block to initialize multiplication tables
    ...
    public double[] toArray() {
        return new double[] { a0, a1, a2, a3, a4, a5, a6, a7 };
    }
